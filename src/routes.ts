...
export function directRouteWrapper(page: Page.ResponsePage, additional_options?: any): string {
    const current_registry_config = registry_config.get();
    ...
    const frontend_page_object: Page.ResponsePage = {
        ...
        parsed_content: encodeURIComponent(page.parsed_content || ""),
...
ede.current_page = ${ JSON.stringify(frontend_page_object) }`];
    ...
    return Sqrl.Render(current_skin_html, {
        ...
        ede_page_subnametext: current_registry_config["instance.page_subnametext"].value as string || "",
        ...
        ede_instance_displayname: current_registry_config["instance.display_name"].value as string,
