...
window.ede = {
    ...
    showPopup: function(id, title, body_html, height, width) {
        ...
        // popup_el.style.height = `${ height }px`;
        // popup_el.style.marginTop = `-${ height / 2 }px`;
...
<div class="bottom">
    <div class="buttons-container">
        ...
        <div class="right">
            <div onclick="ede.closePopup()" class="ui-button1 t-frameless c-blue w-500">DISMISS</div>
        </div>
    </div>
</div>
`;
