...
<div class="right">
    ...
    createElevatedSession: function(callback, force_popup) {
        ...
        const create_session = () => {
            // Get the password
            const password = document.querySelector("#popupid-user-createelevatedsession .password-field").value;
...
<div class="right">
    <button name="continue" class="ui-button1 t-frameless c-blue w-500">CONTINUE</button>
</div>`;
...
<div class="ui-input-box" style="margin-top: 25px">
    ...
    <input type="password" name="password" data-handler="password" class="ui-input1 password-field">
</div>
        `;
        ...
        !ede.element.template.ede_page_main_content_container.className.includes("nocontainer")) {
            ...
            if(ede.element.page_action_buttons.manage) {
                ...
                ede.element.page_action_buttons.manage.onclick = () => {
                    ede.navigate(`/System:WikiPageManagement/info/${ ede.current_page.address.namespace }:${ ede.current_page.address.name }`);
                };
                ...
                ede.element.page_action_buttons.manage.oncontextmenu = () => {
                    ...
                    for(const link_el of links) {
                        link_el.onclick = e => {
                            ...
                            ede.navigate(`/System:WikiPageManagement/${ link_el.getAttributeNames()[1] }/${ ede.current_page.address.namespace }:${ ede.current_page.address.name }`);
                        };
                    }
